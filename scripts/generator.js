import { createNode, createNodeWithInner } from "./utils.js";
...
export function createShimonokuCard(card, showNumber) {
    ...
    shimonokuContainer.appendChild(createNodeWithInner("p", card.number, showNumber ? "number-indicator show-number" : "number-indicator"));
